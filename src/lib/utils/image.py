...
# heatmap:[h, w]
# radius:[rh, rw]
def draw_ellipse_gaussian(heatmap, center, radius, k=1):
    h_diameter = 2 * radius[0] + 1
    w_diameter = 2 * radius[1] + 1
    gaussian = ellipseGaussian2D((h_diameter, w_diameter), sigma=[h_diameter / 6, w_diameter / 6])
